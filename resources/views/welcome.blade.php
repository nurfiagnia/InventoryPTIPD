...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>PTIPD - UIN SGD Bandung</title>
    ...
    <div class="wrapper">
		...
		<div class="konten">
			<aside>
				<center style="margin-bottom: 20px;"><h3>Peminjaman</h3></center>
                <h5>Tanggal Peminjaman :</h5>
                <input type="date" class="form-control" style="margin-bottom: 20px;">
                <h5>Tanggal Pengembalian :</h5>
                <input type="date" class="form-control" style="margin-bottom: 20px;">
                <a href="/barang"><center><input type="submit" value="Cek Barang" class="btn btn-success m-2"></center></a>
			</aside>
			<!--menu utama-->
			<div id="utama">
			     @yield('barang')
